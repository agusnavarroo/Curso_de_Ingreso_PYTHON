...
class App(customtkinter.CTk):
    ...
    def btn_informar_on_click(self):
        match self.combobox_estaciones.get() :
            case "Invierno" :
                alert("Alerta", "Solo se viaja a Bariloche")
            case "Verano" :
                alert("Alerta", "Se viaja a Mar del plata y Cataratas")
            case "Otoño" :
                alert("Alerta", "Se viaja a todos los lugares")
            case _:
                alert("Alerta", "Se viaja a todos los lugares menos Bariloche")
