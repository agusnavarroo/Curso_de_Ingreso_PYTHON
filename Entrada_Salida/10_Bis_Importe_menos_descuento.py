...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        descuentio_texto = self.txt_descuento.get()
        importe_numero = float(self.txt_importe.get())
        descuento_numero = float(self.txt_descuento.get())
        nuevo_importe_numero = (importe_numero * descuento_numero / 100)
        importe_final_numero = importe_numero - nuevo_importe_numero
        mensaje = "Su nuevo importe es de: {0}  pesos".format(importe_final_numero)
