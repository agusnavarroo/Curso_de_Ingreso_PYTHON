...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        if edad_numero >= 18 :
            alert(title="Alerta", message="Es mayor")                          
        else :
            if edad_numero < 10 :
                alert(title="Alerta", message="Es niño/a")
            else :
                if edad_numero >= 13 and edad_numero <=17 :
                    alert(title="Alerta", message="Es adolescente")
                else: 
                    alert(title="Alerta", message="Es pre-adolescente")
