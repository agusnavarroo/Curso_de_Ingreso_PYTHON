...
transformarlo en número e informar si la persona "NO ES ADOLESCENTE" utilizando el Dialog Alert. Para ser adolescente tiene que ser >= 13 y <=17 (Tener en cuenta esto)
'''
